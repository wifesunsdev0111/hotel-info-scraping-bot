...
SAMPLE_SPREADSHEET_ID = '1cVtIacLhxddMI0DhNtfefxBulGaBTJblrXvnx85uh_A' 
SAMPLE_RANGE_NAME = 'makemytrip1!A2:OP'
...
def insert_data(data_range, all_hotel_info):
                
    data_body = {
        'values': [all_hotel_info]
    }
